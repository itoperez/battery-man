...
#define UE_PROJECT_NAME ThirdPersonCPP
#define UE_TARGET_NAME ThirdPersonCPPEditor
#define UE_MODULE_NAME "ThirdPersonCPP"
...
#define THIRDPERSONCPP_API DLLEXPORT
